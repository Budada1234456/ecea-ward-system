...
export function DisciplineSelector({
  ...
  const browsePath = useMemo(
    () => getDisciplinePath(disciplines, parentCode),
    [disciplines, parentCode],
  );
  ...
  const pathLabel = (item) =>
    getDisciplinePath(disciplines, item.code)
  ...
  const selectDiscipline = (item) => {
    ...
    const path = getDisciplinePath(disciplines, item.code).map(
      (node) => node.code,
    );
    onChange([
      ...selection,
